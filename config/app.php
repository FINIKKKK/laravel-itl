...
return [
    ...
    |--------------------------------------------------------------------------
    */
    // Статус ошибки аунтефикации пользователя
    'auth_error_status' => env('AUTH_ERROR_STATUS', 401),
    // Сообщение ошибки аунтефикации пользователя
    'auth_error_message' => env('AUTH_ERROR_MESSAGE', 'Пользователь не аутентифицирован'),
    // Статус основной ошибки (неправильный запрос)
    ...
    */
    ...
    'path' => [
        ...
        'img' => [
            // Основной путь изображений
            'main' => 'uploads/img',
            // Путь для аватарок пользователей
            'avatar' => 'uploads/img/avatars',
        ],
    ],
    ...
    */
    // Время жизни токена
    'token_lifetime' => env('TOKEN_LIFETIME', 20160),
